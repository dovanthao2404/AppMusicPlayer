...
const app = {
  ...
  randomSong: function () {
    var randomCurrent = 0;
    do {
      randomCurrent = Math.floor(Math.random() * this.songs.length);
    } while (randomCurrent === this.currentIndex ||
      randomCurrent >= this.songs.length);
    this.currentIndex = randomCurrent;
    this.loadCurrentSong();
  },
  start: function () {
